...
class Bill_App:
    def __init__(self,root):
        ...
        title=Label(self.root,text="Biling Software",font=('times new roman',30,'bold'),pady=2,bd=12,bg="#badc57",fg="Black",relief=GROOVE)
        title.pack(fill=X)
        #=============variables==========================
    ...
    def total(self):
        ...
        self.c_m_d_p=self.mountain_duo.get()*10
    ...
    def bill_area(self):
        ...
        if self.mountain_duo.get()!=0:
           self.txtarea.insert(END,f"\n Mountain Duo\t\t{self.sanitizer.get()}\t\t{self.c_m_d_p}")
           self.txtarea.insert(END, f"\n--------------------------------")
        #===============taxes==============================
