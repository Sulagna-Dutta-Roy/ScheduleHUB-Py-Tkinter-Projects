...
Tops=Frame(root,width=1600,height=600,bg="sky blue",relief=GROOVE)
Tops.pack(side=TOP)

f1=Frame(root,width=900,height=700,bg="sky blue",relief=GROOVE)
f1.pack(side=LEFT)
...
#=========================================================================================================
btnTotal=Button(f1,padx=16,pady=8,bd=10,fg="black",font=('arial',20,'bold'),width=9,
                text="Total",bg="sky blue",command=Total).grid(row=7,column=1)
btnReset=Button(f1,padx=16,pady=8,bd=10,fg="black",font=('arial',20,'bold'),width=9,
                text="Reset",bg="sky blue",command=Reset).grid(row=7,column=2)
btnExit=Button(f1,padx=16,pady=8,bd=10,fg="black",font=('arial',20,'bold'),width=9,
                text="Exit",bg="sky blue",command=Exit).grid(row=7,column=3)
root.mainloop()
